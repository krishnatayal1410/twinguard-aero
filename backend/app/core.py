...
class Settings:
    ...
    version: str = "3.0.0"
    environment: str = os.getenv("TWINGUARD_ENV", "development")
    ...
    mqtt_enabled: bool = os.getenv("MQTT_ENABLED", "0") == "1"
    ...
    unreal_udp_enabled: bool = os.getenv("UNREAL_UDP_ENABLED", "0") == "1"
